...
class SixthLevelBardList extends StatefulWidget {
  const SixthLevelBardList({Key? key}) : super(key: key);

  @override
  State<SixthLevelBardList> createState() => _SixthLevelBardListState();
}

class _SixthLevelBardListState extends State<SixthLevelBardList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Magias de nível 6'),
      ),
      body: ListView(

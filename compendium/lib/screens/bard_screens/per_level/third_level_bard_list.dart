...
class ThirdLevelBardList extends StatefulWidget {
  const ThirdLevelBardList({Key? key}) : super(key: key);

  @override
  State<ThirdLevelBardList> createState() => _ThirdLevelBardListState();
}

class _ThirdLevelBardListState extends State<ThirdLevelBardList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Magias de nível 3'),
        ),
        body: ListView(

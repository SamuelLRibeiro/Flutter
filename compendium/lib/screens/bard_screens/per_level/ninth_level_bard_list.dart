...
class NinthLevelBardList extends StatefulWidget {
  const NinthLevelBardList({Key? key}) : super(key: key);

  @override
  State<NinthLevelBardList> createState() => _NinthLevelBardListState();
}

class _NinthLevelBardListState extends State<NinthLevelBardList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Magias de nível 9'),
      ),
      body: ListView(

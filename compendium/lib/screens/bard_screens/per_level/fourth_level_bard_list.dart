...
class FourthLevelBardList extends StatefulWidget {
  const FourthLevelBardList({Key? key}) : super(key: key);

  @override
  State<FourthLevelBardList> createState() => _FourthLevelBardListState();
}

class _FourthLevelBardListState extends State<FourthLevelBardList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Magias de nível 4'),
      ),
      body: ListView(

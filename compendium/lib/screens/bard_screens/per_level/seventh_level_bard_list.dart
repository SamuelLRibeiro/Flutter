...
class SeventhLevelBardList extends StatefulWidget {
  const SeventhLevelBardList({Key? key}) : super(key: key);

  @override
  State<SeventhLevelBardList> createState() => _SeventhLevelBardListState();
}

class _SeventhLevelBardListState extends State<SeventhLevelBardList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Magias de nível 7'),
      ),
      body: ListView(

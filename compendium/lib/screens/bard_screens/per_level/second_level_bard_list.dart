...
class SecondLevelBardList extends StatefulWidget {
  const SecondLevelBardList({Key? key}) : super(key: key);

  @override
  State<SecondLevelBardList> createState() => _SecondLevelBardListState();
}

class _SecondLevelBardListState extends State<SecondLevelBardList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Magias de nível 2'),
        ),
        body: ListView(

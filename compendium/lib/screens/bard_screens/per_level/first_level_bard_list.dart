...
class FirstLevelBardList extends StatefulWidget {
  const FirstLevelBardList({Key? key}) : super(key: key);

  @override
  State<FirstLevelBardList> createState() => _FirstLevelBardListState();
}

class _FirstLevelBardListState extends State<FirstLevelBardList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Magias de nível 1'),
      ),
      body: ListView(

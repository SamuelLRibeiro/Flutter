...
class ZeroLevelBardList extends StatefulWidget {
  const ZeroLevelBardList({Key? key}) : super(key: key);

  @override
  State<ZeroLevelBardList> createState() => _ZeroLevelBardList();
}

class _ZeroLevelBardList extends State<ZeroLevelBardList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Magias de nível 0 (Truques)'),
        ),
        body: ListView(

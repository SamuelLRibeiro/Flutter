...
class BardMagicsList extends StatefulWidget {
  const BardMagicsList({Key? key}) : super(key: key);

  @override
  State<BardMagicsList> createState() => _BardMagicsListState();
}

class _BardMagicsListState extends State<BardMagicsList> {
